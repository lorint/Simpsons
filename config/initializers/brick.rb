...
if ActiveRecord::Base.respond_to?(:brick_select) && !::Brick.initializer_loaded
  ...
  #                                  '::Snake' => 'Reptile' }
  Brick.sti_namespace_prefixes = { '::Athlete' => 'User' }
  ...
  # # Here is a possible polymorphic association that has been auto-identified for the simpsons_development database:
  # Brick.polymorphics = {  }
